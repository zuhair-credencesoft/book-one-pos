    ...
    <div className={styles.contactContainer}>
        ...
        <div className={styles.rightSection}>
            ...
            <form className={styles.formGroup} type='submit'>
                ...
                <input onChange={handleChange} type="text" placeholder='Phone Number' name='number' value={number} />
                <input onChange={handleChange} type="text" placeholder='City' name='city' value={city} />
                <input onChange={handleChange} type="text" placeholder='Restaurant Name' name='restaurantName' value={restaurantName} />
